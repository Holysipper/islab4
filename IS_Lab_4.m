...
pozymiai_skaicius = pozymiai_raidems_atpazinti('skaicius.JPG', 1);
...
figure(10);
title('Skaičius su 13 neuronų RBFN');
text(0.1,0.5,atsakymas_sk,'FontSize',38), axis off

% Patikrinama kaip tinklas atpažįsta simbolius su 8 neuronais
...
figure(11);
title('Skaičius su 8 neuronų RBFN');
text(0.1,0.5,atsakymas_sk_t2,'FontSize',38), axis off

% Patikrinama kaip tinklas atpažįsta simbolius su 5 neuronais
...
figure(12);
title('Skaičius su 5 neuronų RBFN');
